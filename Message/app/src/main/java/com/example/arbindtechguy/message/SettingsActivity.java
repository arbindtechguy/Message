...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingsDisplayProfileImage=findViewById(R.id.circleImageView);
        settingsDisplayname = findViewById(R.id.accountName);
        settingsDisplayStatus = findViewById(R.id.settingStatus);
        settingsChangeProfileImage = findViewById(R.id.buttonChangePicture);
        settingsChangeStatus = findViewById(R.id.buttonChangeStatus);
        ...
        settingsChangeProfileImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(galleryIntent,GALARY_PIC);
            }
        });
                ...
                filepath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if (task.isSuccessful()){
                                        ...
                                        getUserDataReference.updateChildren(update_user_data)
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        Toast.makeText(SettingsActivity.this, "Sucess : Profile Image uploaded", Toast.LENGTH_SHORT).show();
                                                        loadingbar.dismiss();
                                                    }
                                                });
                                      }
                            ...
                            Toast.makeText(SettingsActivity.this, "Error While Uploading pic....", Toast.LENGTH_SHORT).show();
                            loadingbar.dismiss();
                        }
                    }
                });
